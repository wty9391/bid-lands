...
result_root = '/home/wty/CA-research-framework/src/python/wty/z_pdf_Markov_network/result/'
...
def main(campaign_list):
    ...
    for campaign in campaign_list:
        ...
        for mode in MODE_LIST:
            ...
            # getDataset
            dataset = getTrainData(info.fname_trainlog, RROOT)
